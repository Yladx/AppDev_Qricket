  ...
  Future<void> _createPredefinedEvents() async {
    final predefinedEvents = [
      EventModel(
        ...
        maxParticipants: 500,
        existingComments: [
          {'comment': 'Excellent speakers and content!', 'rating': 5},
          {'comment': 'Great networking opportunities', 'rating': 4},
          {'comment': 'Well-organized event', 'rating': 5},
          {'comment': 'Inspiring presentations', 'rating': 4},
          {'comment': 'Good venue and facilities', 'rating': 4},
        ],
      ),
      EventModel(
        id: '1000000002',
        ...
        existingComments: [
          {'comment': 'Amazing performances!', 'rating': 5},
          {'comment': 'Great atmosphere and vibes', 'rating': 5},
          {'comment': 'Well-coordinated logistics', 'rating': 4},
          {'comment': 'Fantastic food options', 'rating': 4},
          {'comment': 'Perfect weather and setting', 'rating': 5},
        ],
      ),
      EventModel(
        id: '1000000003',
        ...
        maxParticipants: 100,
        existingComments: [
          {'comment': 'Very informative and practical', 'rating': 5},
          {'comment': 'Great networking opportunities', 'rating': 4},
          {'comment': 'Professional and well-structured', 'rating': 5},
          {'comment': 'Valuable insights shared', 'rating': 4},
          {'comment': 'Excellent facilitator', 'rating': 5},
        ],
      ),
    ];
